        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div class="lg:col-span-5 space-y-6 sticky top-24">
                <div class="bg-white border border-stone-200/80 rounded-2xl p-6 shadow-sm space-y-5">
                    ...
                    <button type="submit" class="w-full py-4 bg-[#58111A] hover:bg-[#3B0A11] border border-[#D4AF37]/50 text-[#F7EED9] font-bold text-xs uppercase tracking-[0.2em] text-center rounded-xs shadow-lg transition flex items-center justify-center gap-2">
